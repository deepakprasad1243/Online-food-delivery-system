      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
						...
						<li class="bold"><a href="restaurent.php" class="waves-effect waves-cyan"><i class="mdi-maps-local-restaurant"></i> Restaurents</a>
            </li>
                <li class="no-padding">
...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Item Price/Piece</th>
												<th data-field="name">Item image</th>
                      </tr>
                    </thead>
				...
				<?php
					...
					echo '<input id="image" name="image" type="file" data-error=".errorTxt03" required><div class="errorTxt03"></div></td>';
					echo '<td></tr>';
				?>
                    </tbody>
</table>
