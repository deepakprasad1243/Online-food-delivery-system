								...
								<ul class="collapsible collapsible-accordion">
										<li class="bold"><a class="collapsible-header waves-effect waves-cyan <?php if(isset($_GET['restaurent'])) echo 'active';?>"><i class="mdi-maps-local-restaurant"></i>Filter Restaurents</a>
												<div class="collapsible-body">
														<ul>
						<li class='<?php echo (isset($_GET['restaurent'])?($_GET['restaurent']=='All Restaurents' ? 'active' : ''): '')?>'><a href="index.php?restaurent=All Restaurents">All Restaurents</a>
														</li>
														<?php
															...
															while($row = mysqli_fetch_array($sql)){
																if(isset($_GET['restaurent'])){
																	$restaurent = $row['name'];
																								...
																								echo '<li class='.(isset($_GET['restaurent'])?($restaurent == $_GET['restaurent'] ? 'active' : ''): '').'><a href="index.php?restaurent='.$row['name'].'">'.$row['name'].'</a>
																								</li>';
															}
															?>
														</ul>
